...
public class NEIHandlerBottler extends RecipeHandlerBase {
    ...
    public class CachedBottlerRecipe extends CachedBaseRecipe {
        ...
        public CachedBottlerRecipe(BottlerRecipe recipe) {
            if (recipe.input != null) {
                this.fluid = new PositionedFluidTank(
                        recipe.input,
                        10000,
                        new Rectangle(48, 6, 16, 58),
                        NEIHandlerBottler.this.getGuiTexture(),
                        new Point(176, 0));
            }
    ...
    public String getRecipeName() {
        return StringUtil.localizeGuiTitle("tile.for.factory.0.name");
    }
