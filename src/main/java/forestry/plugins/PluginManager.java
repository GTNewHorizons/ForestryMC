...
public class PluginManager {
    ...
    public enum Stage {
        SETUP, // setup API to make it functional, register basic blocks and items. GameMode Configs are not yet
        // accessible
        SETUP_DISABLED, // setup fallback API to avoid crashes
        PRE_INIT, // register handlers, triggers, definitions, backpacks, crates, and anything that depends on basic
        // items
