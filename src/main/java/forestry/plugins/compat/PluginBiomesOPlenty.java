...
@Plugin(
        ...
        author = "Nirek",
        url = Constants.URL,
        unlocalizedDescription = "for.plugin.biomesoplenty.description")
public class PluginBiomesOPlenty extends ForestryPlugin {
    ...
    protected void registerBackpackItems() {
        ...
        addBlocksToBackpack(MINER, "driedDirt", "overgrownNetherrack", "cragRock", "ashStone");
        ...
        addBlocksToBackpack(FORESTER, "petals");
    }
