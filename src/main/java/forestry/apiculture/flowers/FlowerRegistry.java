        ...
        if (PluginManager.Module.AGRICRAFT.isEnabled()) {
            ...
            if (block == cropBlock) {
                if (block instanceof IPlantable) {
                    ...
                    if (drops.get(1).getItem() == Items.wheat_seeds
                            && flowerType.equals(FlowerManager.FlowerTypeWheat)) {
                        return true;
                    }
                    if (drops.get(1).getItem() == Items.nether_wart
                            && flowerType.equals(FlowerManager.FlowerTypeNether)) {
                        return true;
                    }
                }
            }
